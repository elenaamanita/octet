	...
	/// Scene containing a box with octet.
		class Game_Shapes : public app {
			...
			void init_shiningbox(){
				...
				b = new param_shader("octet/src/examples/Game_Shapes_Octet/base_vertex.vs", "octet/src/examples/Game_Shapes_Octet/shining.fs");
		...
		public:
			Game_Shapes(int argc, char **argv) : app(argc, argv) {
			}
